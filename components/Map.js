...
function Map({ searchResults }) {
    ...
    return (
        <ReactMapGL 
            mapStyle="mapbox://styles/14sandee/cks1mnfrq63jh18qgefi16nf3"
            mapboxApiAccessToken="pk.eyJ1IjoiMTRzYW5kZWUiLCJhIjoiY2tzMWpxdzdtMGt2ZzJ2cGUwbHZ4MzVudCJ9.G9-X_8GsYP1HIwl1GwDCqQ"
            {...viewport}
